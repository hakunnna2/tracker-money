    ...
    <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 lg:gap-8 pb-10">
              ...
              <div key={acc.id} className="bg-white p-6 rounded-3xl shadow-brand border border-slate-100 flex flex-col justify-between group">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all">
                    <button onClick={() => startEdit(acc)} className="text-slate-300 hover:text-brand-blue transition-all cursor-pointer">
                      <Pencil size={16} />
                    </button>
                    <button onClick={() => onDelete(acc.id)} className="text-slate-300 hover:text-brand-danger transition-all cursor-pointer">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </div>
                ...
                {editingId === acc.id ? (
                  <div className="mt-4 space-y-3">
                    ...
                    <div>
                      <label className="text-[10px] font-bold text-brand-muted uppercase block mb-1 tracking-wider">Initial Balance ($)</label>
                      <input
                        type="number"
                        value={editBalance}
                  ...
                  <>
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-brand-muted mt-1">Initial: ${acc.balance.toLocaleString(undefined, { minimumFractionDigits: 2 })}</p>
                    </div>
      ...
      >
        ...
        <div className="space-y-5">
          ...
          <div>
            <label className="text-[10px] font-bold text-brand-muted uppercase block mb-1.5 tracking-wider">Initial Balance ($)</label>
            <input 
              type="number" 
          ...
          <button 
            onClick={() => {
              ...
              onAdd({ id: crypto.randomUUID(), name: trimmedName, type, balance: initialBalance });
              setName('');
              setInitialBalance(0);
            }}
